{ pkgs, config, ... }: {
  config = {
    ...
    programs.pm2.services = [{
      ...
      args = "-m vllm.entrypoints.openai.api_server --model GadflyII/GLM-4.7-Flash-NVFP4 --dtype auto --max-model-len 131072 --gpu-memory-utilization 0.85 --port 8000 --host 127.0.0.1 --trust-remote-code";
